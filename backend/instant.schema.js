...
const schema = i.schema({
  entities: {
    ...
    "users": i.entity({
      ...
      "emailVerificationExpires": i.number().optional(),
      "passwordResetToken": i.string().optional(),
      "passwordResetExpires": i.number().optional(),
      "pendingEmail": i.string().optional(),
      "changeEmailToken": i.string().optional(),
      "changeEmailExpires": i.number().optional(),
    }),
